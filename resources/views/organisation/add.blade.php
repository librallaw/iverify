        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a class="navbar-brand" href="javascript:;">Create Organisation</a>
                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card ">
                                <div class="card-header card-header-danger card-header-icon">
                                    ...
                                    <h4 class="card-title">Create Organisation</h4>
                                </div>
                                <div class="card-body ">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="input-group input-group-dynamic my-3">
                                                <label class="form-label">Organiasation Name</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group input-group-dynamic my-3">
                                                <label class="form-label">Organisation Password</label>
