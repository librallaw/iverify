        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                @if($user->active == 0)
                    <br />
                    <br />
                    <a href="{{route("ActivateOrganisation",['orgid'=> $user->unique_id])}}">
                        <button class="btn btn-success">Click here to Activate</button>
                    </a>
                @endif
                ...
                <div class="card ">
                    <div class="card-header card-header-icon card-header-rose">
                        ...
                        <h4 class="card-title ">Organisation Details
                            <small class="description" style=""></small>
...
{{--                        <a href="{{route("showAccountVerfiyLog",['user'=> $user->unique_id])}}"><button class="btn btn-dribbble">Verification logs</button></a>--}}
                    ...
                    <div class="card-body ">
                        ...
                        <div class="row" >
                            ...
                            <div class="col-md-12">
                                <div class="alert alert-danger alert-dismissable" align="center" style="color:white;">
                                    Note that the logged in Admin's password is required to top credit
                                </div>
                                <br />
                                <br />
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="card card-pricing">
                                        ...
                                        <h6 class="card-category card-header"> Available Credits</h6>



                                        <div class="card-body">
                                            <h3 class="">{{$user->balance}}</h3>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="card card-pricing">
                                        ...
                                        <h6 class="card-category card-header"> Total Awarded Credits</h6>


                                        <div class="card-body">
                                            <h3 class="">0{{$user->total_credits}}</h3>
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-md-12">
                                            <div class="card card-pricing">
                                                ...
                                                <h6 class="card-header">Top up Credits</h6>
                                                    ...
                                                    <form method="post" action="{{route("doCreditWallet")}}">
                                                        ...
                                                        <div class="input-group input-group-dynamic my-3">
                                                            ...
                                                            <input type="password" name="password" class="form-control"
                                                                   id="" required>
                                                            <input type="hidden"
                                                                   name="orgid" value="{{$user->unique_id}}">
                                                        </div>


                                                        <button type="submit" class="btn btn-round btn-danger"> Top Up
                                                        </button>
                                                    </form>
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="card card-pricing">
                                                ...
                                                <div class="alert alert-rose">Withdraw Credits</div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form method="post" action="{{route("doWithdrawWallet")}}">
                                                        ...
                                                        <div class="">
                                                            <div class="input-group input-group-dynamic my-3">
                                                                <label class="form-label">Amount of credits</label>
                                                                <input type="number" name="amount" min="1" max="{{$user->wallet}}" class="form-control"
                                                                       id="" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <button type="submit" class="btn btn-round btn-danger"> Withdraw
                                                        </button>
                                                    </form>
                                                </div>
                                                        ...
                                                        <div>
                                                            <form method="post" action="{{route("doEditUser")}}">
                                                                ...
                                                                <div class="input-group input-group-dynamic my-3">
                                                                    ...
                                                                    <input type="email" name="email" value="{{$user->email}}" class="form-control" id="examwpleEmail">
                                                                </div>

                                                                <div class="input-group input-group-dynamic my-3">
                                                                    <label for="exampleEmail" class="form-label">Phone</label>
                                                                    <input type="text" name="phone" value="{{$user->phone}}" class="form-control" id="examwpleEmail">
                                                                </div>
                                                                <div class="input-group input-group-dynamic my-3">
                                                                    <label for="exampleEmail" class="form-label">Username</label>
                                                                    <input type="text" name="username"
                                                                           value="{{$user->unique_id}}" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="card card-pricing" style="margin-top:30px;">


                                    <div class="alert alert-rose">Verification Logs</div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        @if(count($logs) > 0)
                                            <div class="material-datatableds table-responsive">
                ...
                <div class="pull-right">
                    <a href="#" id="buttoner">
                        <button class="btn btn-dribbble" id="">Delete Account</button>
                    </a>
                </div>
                <br />
                <br />
                @if($user->active == 1)
                    <br />
                    <a href="{{route("ActivateOrganisation",['orgid'=>$user->unique_id])}}">
                        <button class="btn btn-danger">Click here to Deactivate</button>
                    </a>
                @endif
            </div>
