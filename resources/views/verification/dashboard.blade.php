                            ...
                            <div class="card ">
                                ...
                                <div class="card-body ">
                                    <form method="post" action="{{route("DoLoadVerification")}}" id="search_by_nin">
                                        @csrf
                                        <div class="input-group input-group-dynamic my-">
                                            <label for="exampleEmail" class="form-label">Enter NIN ID</label>
                ...
                <!-- end content-->
                        ...
                        <div class="col-md-4" style="margin-bottom: 30px">
                            <div class="card ">
                                ...
                                <div class="card-body ">
                                    <form method="post" action="{{route("DoLoadVerificationData")}}" id="searchByDemoData">
                                        @csrf
                                        <div class="input-group input-group-dynamic my-">
                                        ...
                                        <div class="input-group input-group-dynamic my-">
                                            ...
                                            <input type="text" name="dateOfBirth" class="form-control" id="" required>
