        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a class="navbar-brand" href="javascript:;">Data Page</a>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div>
                                    ...
                                    <form method="post" action="{{route("downloadData")}}" target="_blank">
                                        @csrf
                                    ...
                                    <button type="submit" class="btn btn-primary pull-center">Download Pdf</button>
