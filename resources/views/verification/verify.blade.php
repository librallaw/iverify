    ...
    <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
      <div class="container-fluid">
        <div class="navbar-wrapper">
          <a class="navbar-brand" href="javascript:;">Verification</a>
        </div>
    ...
    <div class="col-md-4">
      ...
      <div class="card ">
        <div class="card-header card-header-warning card-header-icon">
          ...
          <h4 class="card-title">Verify by NIN</h4>
        </div>
        <div class="card-body ">
          <form action="{{route("DoLoadVerification")}}"  method="post">
            @csrf
            <div class="row">
    ...
    <div class="col-md-4">
      ...
      <div class="card ">
        <div class="card-header card-header-info card-header-icon">
          ...
          <h4 class="card-title">Verify by Phone Number</h4>
        </div>
        <div class="card-body ">
          <form action="{{route("DoLoadVerification")}}" method="post">
            @csrf
 ...
 <div class="col-md-4">
      ...
      <div class="card ">
        <div class="card-header card-header-danger card-header-icon">
          ...
          <h4 class="card-title">Verify by Demo Data</h4>
        </div>
        <div class="card-body ">
          <form action="{{route("DoLoadVerificationDemo")}}" method="post">
            @csrf
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="input-group input-group-dynamic my-3">
                  <label class="form-label">Date of birth <small>format: dd-mm-yyyy (12-05-1960)</small></label>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vaafb692b2aea4879b33c060e79fe94621666317369993" integrity="sha512-0ahDYl866UMhKuYcW078ScMalXqtFJggm7TmlUtp0UlD4eQk0Ixfnm5ykXKvGJNFjLMoortdseTfsRT8oCfgGA==" data-cf-beacon='{"rayId":"78494a17d9de0eaf","version":"2022.11.3","r":1,"token":"1b7cbb72744b40c580f8633c6b62637e","si":100}' crossorigin="anonymous"></script>
</body>
